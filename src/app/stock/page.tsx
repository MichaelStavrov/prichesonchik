...
const StockPage = () => {
  ...
  const stockItems = [
    {
      name: '25 января - Татьянин день',
      img: '/stock-2.jpg',
      desc: (
        <div className={styles.stockItemDesc}>
          <p>Поздравляем всех Татьян с их наступающим фирменным днем!</p>
          <p>
            И дарим от салона приятный подарок - скидку 50% на стрижки и укладки
            25&nbsp;января.
          </p>
          <p>
            Внимание! Скидка действительна, если вы покажете администратору
            любой документ, подтверждающий, что вы или ваш ребенок Татьяна
          </p>
        </div>
      ),
    },
